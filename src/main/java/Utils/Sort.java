...
public class Sort {
  ...
  public static void quickSort(int[] array, double[] values, int low,
                               int high) {
    if (low < high) {
      int tmp = array[low];
  ...
  public static void quickSort(int[] array, int[] values, int low,
                               int high) {
    if (low < high) {
      int tmp = array[low];
  ...
  public static void selectionSort(int[] a, int[] y, int from, int to,
                                   IntComparator comp) {
